          ...
          <div className="row align-items-center">
            <div className="col-lg-5 mb-40">
              ...
              <h1 className="heading-1 neutral-0">
                More than 80,000+ companies trusted Edvisors Platform
              </h1>
            </div>
                ...
                <div className="box-sliders-award-bottom">
                  <div className="list-slider-award">
                    <div className="slider-award-1">
                      <div
                        className="carouselTicker3 carouselTicker_vertical"
                        id="slide-top-award"
                      >
                    ...
                    <div className="slider-award-2">
                      <div
                        className="carouselTicker4 carouselTicker_vertical"
                        id="slide-bottom-award"
                      >
                        <li className="carouselTicker__item">
                          <div className="item-logo-2">
                            <img
                    ...
                    <div className="slider-award-3">
                      <div
                        className="carouselTicker5 carouselTicker_vertical"
                        id="slide-top-award-2"
                      >
                        <li className="carouselTicker__item">
                          <div className="item-logo-2">
                            <img
