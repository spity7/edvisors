      ...
      <section className="section-box box-our-features">
        <div className="container">
          <div className="text-center">
            <span className="btn btn-bg-linear-2 mb-25">
              <span>
                <svg
                  width={24}
                  height={24}
          ...
          <div className="row align-items-center">
            <div className="col-lg-3 text-end">
              ...
              <div className="card-feature">
                <div className="card-image">
                  <img
                    src="/assets/imgs/page/homepage6/transaction.png"
                    alt="Nivia"
                  />
                </div>
                <div className="card-info">
            ...
            <div className="col-lg-3">
              <div className="card-feature">
                <div className="card-image">
                  <img
                    src="/assets/imgs/page/homepage6/great.png"
                    alt="Nivia"
                  />
                </div>
                <div className="card-info">
              ...
              <div className="card-feature">
                <div className="card-image">
                  <img
                    src="/assets/imgs/page/homepage6/rapid.png"
                    alt="Nivia"
                  />
                </div>
                <div className="card-info">
