              ...
              <div className="row">
                ...
                <div className="col-lg-3 col-md-6 mb-30">
                  ...
                  <ul className="menu-footer">
                    ...
                    <li>
                      <Link href="#">Business Reform</Link>
                    </li>
                    <li>
                      <Link href="#">Firewall Advance</Link>
                    </li>
                    <li>
                      {" "}
                      <Link href="#">Interactions</Link>
                    </li>
                    <li>
                      {" "}
                      <Link href="#">SEO</Link>
          ...
          <div className="footer-bottom mt-0">
            <div className="row align-items-end">
              <div className="col-lg-6 mb-20">
                <h5 className="text-18-semibold neutral-0">
                  Join our newsletter
                </h5>
                <p className="text-sm neutral-600 mb-20">
