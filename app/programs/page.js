            ...
            <div className="container">
              <div className="row align-items-end">
                <div className="col-lg-7 mb-40">
                  <h2 className="heading-1 text-linear-3 fw-bold">
                    Our Programs
                  </h2>
                </div>
                <div className="col-lg-5 mb-40">
                  <div className="box-info-num">
                    ...
                    <p className="text-md neutral-0">
                      Increase in engagement and learning efficiency across our
                      Robotics, Skills, and ESL programs.
                    </p>
                  </div>
                </div>
              </div>
          ...
          {/* <section className="section-box wow animate__animated animate__fadeIn box-why-choose-us mt-40">
            <div className="container">
              ...
              <div className="row">
                ...
                <div className="col-lg-6">
                  <div className="box-image-why">
                    {" "}
                    <img
                      src="/assets/imgs/page/services/img-chart.png"
                      alt="Nivia"
                    />
                    <img
                      src="/assets/imgs/page/services/img-chart2.png"
                      alt="Nivia"
                    />
                  </div>
                  ...
                  <div className="card-preparing-2">
                    ...
                    <div className="card-info">
                      ...
                      <p className="text-md neutral-700">
                        ...
                        distributing valuable, relevant, and engaging content to
                        attract and retain a target audience, ultimately driving
                        brand awareness.
                      </p>
                    </div>
                  </div>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="card-preparing-2">
                    ...
                    <div className="card-info">
                      ...
                      <p className="text-md neutral-700">
                        Refers to the process of reevaluating and improving the
                        internal operations, structure, and strategies of a
                        company to adapt to changing market conditions and
                        achieve better efficiency, profitability.
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="card-preparing-2">
                    ...
                    <div className="card-info">
                      ...
                      <p className="text-md neutral-700">
                        ...
                        resources, including hardware, software, networks, and
                        personnel, to ensure the efficient and secure operation
                        of IT systems in alignment with business objectives.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="col-lg-4 col-md-6">
                  <div className="card-preparing-2">
                    ...
                    <div className="card-info">
                      ...
                      <p className="text-md neutral-700">
                        {" "}
                        An infrastructure plan outlines a comprehensive strategy
                        for designing, building, and maintaining physical and
                        digital infrastructure, ensuring scalability,
                  ...
                  <div className="card-preparing-2">
                    ...
                    <div className="card-info">
                      ...
                      <p className="text-md neutral-700">
                        ...
                        technology, to protect networks and systems from
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <div className="card-feature-2">
                          ...
                          <div className="card-info">
                            ...
                            <p className="text-md neutral-700">
                              Unlocking Audience Insights: A Deep Dive into
                              Engagement Analysis
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <div className="card-feature-2">
                          ...
                          <div className="card-info">
                            ...
                            <p className="text-md neutral-700">
                              Measuring Digital Success: The Power of Engagement
                              Analysis
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <div className="card-feature-2">
                          ...
                          <div className="card-info">
                            ...
                            <p className="text-md neutral-700">
                              Boosting Conversions: Strategies Informed by
                              Engagement Analysis
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="col-lg-6 col-sm-6">
                        <div className="card-feature-2">
                          ...
                          <div className="card-info">
                            ...
                            <p className="text-md neutral-700">
                              Data-Driven Decisions: Leveraging Engagement
                              Analysis for Growth
                            </p>
                          </div>
                        </div>
            ...
            <div className="container">
              ...
              <div className="block-pricing">
                <div className="row">
                  ...
                  <div className="col-lg-4 col-md-6">
                    <div className="card-pricing card-pricing-style-2 card-pricing-style-3 card-pricing-popular">
                      <Link className="btn btn-popular" href="#">
                        Popular
                      </Link>
                      <div className="card-title">
                        <h6>Professional</h6>
