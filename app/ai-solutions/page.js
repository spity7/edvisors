              ...
              <div className="row">
                <div className="col-lg-9 order-lg-last">
                  <div className="head-detail">
                    ...
                    <h3 className="mb-12 fw-bold fs-1">AI Solutions</h3>
                  ...
                  <div className="main-detail">
                    ...
                    <p>
                      Edvisors delivers cutting-edge Artificial Intelligence
                      (AI) solutions tailored to the needs of educational
                      institutions. We help schools integrate AI tools that
                      enhance personalized learning, automate administrative
                      tasks, and prepare students for the future of work.
                    </p>
                    {/* <p>
                    ...
                    <ul>
                      ...
                      <li>
                        AI Chatbots for school website FAQ & student support.
                      </li>
                      <li>
                        Predictive Analytics for early warning systems and
                        student outcomes.
                      </li>
                      <li>
                    ...
                    <div className="title-with-number">
                      <span>3</span>Why It Matters:
                    </div>
                    <ul>
                      <li>
                        AI can reduce teacher workload, personalize learning
                        paths, and provide real-time insights into student
                        progress — transforming education into a more inclusive
                  ...
                  <div className="sidebar">
                    <div className="box-sidebar-rounded">
                      ...
                      <div className="sidebar-content">
                        ...
                        making AI technology accessible and ethical for all
                    ...
                    <div className="box-sidebar-normal">
                      <Link href="#">
                        <img
                          src="/assets/imgs/page/services/ai-chip-artificial-intelligence-future-technology-innovation.jpg"
                          alt="Nivia"
