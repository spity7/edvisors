                ...
                <div className="col-lg-9 order-lg-last">
                  ...
                  <div className="main-detail">
                    ...
                    <p>
                      ...
                      tailored educational technology (EdTech) solutions that
                      enhance teaching, learning, and school operations. Our
                      services combine the latest tools and platforms to create
                      immersive, tech-enhanced learning environments that meet
                    ...
                    <ul>
                      ...
                      <li>
                        Smart classroom installations and interactive display
                        tech.
                      </li>
                      <li>
                        Digital content libraries and e-learning development.
                      </li>
                      <li>
                    ...
                    <div className="title-with-number">
                      <span>3</span>Who It's For:
                    </div>
                    <ul>
                      <li>
                        K–12 schools, international academies, ministries of
                        education, and EdTech startups looking to scale or
                        modernize their digital learning ecosystem.
                      </li>
                      {/* <li>
                  ...
                  <div className="sidebar">
                    <div className="box-sidebar-rounded">
                      ...
                      <div className="sidebar-content">
                        We begin by assessing your school's existing digital
                        infrastructure, then recommend customized solutions that
                        suit your goals, capacity, and budget. Our training and
                        support services ensure smooth adoption and long-term
                        success.
