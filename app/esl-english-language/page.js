    ...
    <>
      ...
      >
        <div className="section-box box-banner-job">
          <img
            className="w-100"
            src="/assets/imgs/page/services/10ways-MainImage.jpg"
            alt="Nivia"
          />
        </div>
              ...
              <div className="row">
                <div className="col-lg-9 order-lg-last">
                  ...
                  <div className="main-detail">
                    ...
                    <p>
                      The ESL English Language Curriculum at Edvisors is
                      designed to support non-native English speakers from
                      Grades 1–12 in acquiring fluency, confidence, and cultural
                      competence in English. The program is immersive,
                      interactive, and tailored to meet the needs of diverse
                      learners.
                    </p>
                    {/* <p>
                    ...
                    <div className="title-with-number">
                      <span>2</span>Curriculum Goals:
                    </div>
                    <ul>
                      <li>
                        Build strong foundations in reading, writing, speaking,
                        and listening.
                      </li>
                      <li>
                        Develop academic vocabulary and grammar for school
                        success.
                      </li>
                      <li>
                    ...
                    <div className="title-with-number">
                      <span>3</span> Key Features:
                    </div>
                    <ul>
                      <li>
                        Differentiated instruction for beginner to advanced
                        levels.
                      </li>
                  ...
                  <div className="sidebar">
                    <div className="box-sidebar-rounded">
                      <div className="sidebar-head">
                        <h6>Beyond the Classroom</h6>
                      </div>
                      <div className="sidebar-content">
                        This curriculum prepares students for global exams
                        (TOEFL Junior, IELTS, etc.) and empowers them to succeed
                        in both local and international academic environments.
                    ...
                    <div className="box-sidebar-normal">
                      <Link href="#">
                        <img
                          src="/assets/imgs/page/services/1520168104559.jpeg"
                          alt="Nivia"
                          style={{
                            borderRadius: "20px",
