              ...
              <div className="row">
                <div className="col-lg-9 order-lg-last">
                  ...
                  <div className="main-detail">
                    ...
                    <p>
                      Edvisors provides expert educational consulting services
                      to help schools grow, innovate, and excel. Our team works
                      closely with school leaders and educators to co-create
                      strategies that align with institutional goals, meet
                      international standards, and drive impactful change.
                    </p>
                    {/* <p>
                    ...
                    <div className="title-with-number">
                      <span>2</span>Our Consulting Services:
                    </div>
                    <ul>
                    ...
                    <div className="title-with-number">
                      <span>3</span>Why Choose Edvisors:
                    </div>
                    <ul>
                      <li>
                        We combine academic insight with global experience to
                        deliver sustainable transformation. Whether launching a
                        new school, seeking accreditation readiness, or
                        improving instructional quality — we are your strategic
                        partner.
                      </li>
                      {/* <li>
                  ...
                  <div className="sidebar">
                    <div className="box-sidebar-rounded">
                      ...
                      <div className="sidebar-content">
                        Our consultants have worked with schools and education
                        ministries across the USA, MENA region, and Africa, with
                        a deep understanding of both local context and
