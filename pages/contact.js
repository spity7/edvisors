...
const Contact = () => {
  return (
    <Layout header={3}>
      ...
      <section className="contact-page-info pt-50 rpt-100 pb-100 rpb-70 rel z-1">
          ...
          <div className="row justify-content-center">
            ...
            <div className="col-xl-3 col-lg-4 col-md-6">
              <div className="contact-info-box wow fadeInUp delay-0-4s">
                ...
                <h4>Phone</h4>
                <span>
                  Mobile : <a href="callto:+000(123)45667">+961/123456</a>
                </span>
                <span>
      ...
      <div className="contact-page-map wow fadeInUp delay-0-2s mb-80">
