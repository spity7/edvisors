import Single2Img from "../../../../assets/images/program1/image-69.webp";
    ...
    <div className="row">
      ...
      <div className="col-lg-6">
        <div className="aximo-default-content">
          ...
          <p>
            Contact us to learn more about how to implement this transformative
            curriculum and empower your students for the future.
          </p>
        </div>
