import Single2Img from "../../../../assets/images/program2/istockphoto-1393379238-612x612.jpg";
    ...
    <div className="row">
      ...
      <div className="col-lg-6">
        <div className="aximo-default-content">
          ...
          <p>
            Incorporating a skills and competencies-based curriculum improves
            student performance, strengthens social-emotional development, and
            prepares students to adapt in a rapidly evolving world.
          </p>
        </div>
