import Single2Img from "../../../../assets/images/program3/10ways-MainImage.jpg";
    ...
    <div className="row">
      ...
      <div className="col-lg-6">
        <div className="aximo-default-content">
          ...
          <p>
            This curriculum prepares students for global exams (TOEFL Junior,
            IELTS, etc.) and empowers them to succeed in both local and
